...
def get_data(id=None):             
    ...
    json_data = json.dumps(data)   #converting our python data to the  json dict using dumpss ... #sending the data from client to the server 
...
def post_data():
    ...
    #defining the headers and calling the content type
    headers = {'content-Type': 'application/json'}
...
def update_data():
    ...
    headers = {'content-Type': 'application/json'}
    json_data = json.dumps(data)
    r = requests.put(url=URL, data=json_data, headers=headers)    #in update we have put request & read we have the post request
    data = r.json()
    print(data)
...
def delete_data():
    ...
    json_data = json.dumps(data)
    headers = {'content-Type': 'application/json'}
    r = requests.delete(url=URL, data=json_data, headers=headers)    #Now we use the delete request to del. the specific record from our db...
    data = r.json()
    print(data)
#delete_data()